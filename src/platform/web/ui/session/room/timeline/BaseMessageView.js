...
export class BaseMessageView extends TemplateView {
    ...
    render(t, vm) {
        ...
        t.mapSideEffect(vm => vm.isContinuation, (isContinuation, wasContinuation) => {
            if (isContinuation && wasContinuation === false) {
                ...
                const avatar = tag.div({className: "Timeline_messageAvatar"}, [renderStaticAvatar(vm, 30)]);
    ...
    createMenuOptions(vm) {
        ...
        options.push(Menu.option(vm.i18n`Copy matrix viewer permalink`, () => vm.copyPermalink()));
        return options;
    }
